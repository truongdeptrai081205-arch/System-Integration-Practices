  ...
  <div class="container">
    <div class="list-section">
      ...
      <div class="top-bar">
        ...
        <div>
          Search:
          <input type="text" v-model="searchText" placeholder="Tìm tên hoặc ngày..." />
        </div>
      </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr v-else-if="paginatedData.length === 0"><td colspan="8" class="text-center">No data available</td></tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-group">
              <label>Birthday</label> <!-- Input ngày sinh -->
...
const savePersonal = () => {
  const newEntry = {
    ...
    birthday: formData.value.birthday || "N/A", // Lưu ngày sinh
